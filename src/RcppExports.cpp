...
RcppExport SEXP crl_read_bigwig_impl(SEXP bwfnameSEXP, SEXP chromSEXP, SEXP startSEXP, SEXP endSEXP) {
BEGIN_RCPP
...
RcppExport SEXP crl_dPCA_main_impl(SEXP nGroupNumSEXP, SEXP nDatasetNumSEXP, SEXP nSampleNumSEXP, SEXP nPairedSEXP, SEXP nLociNumSEXP, SEXP groupIdSEXP, SEXP datasetIdSEXP, SEXP repNumSEXP, SEXP sampleNameSEXP, SEXP lociChrSEXP, SEXP lociStartSEXP, SEXP lociEndSEXP, SEXP vdataSEXP, SEXP nTransformSEXP, SEXP nColMeanCentSEXP, SEXP nColStandSEXP, SEXP nMColMeanCentSEXP, SEXP nMColStandSEXP, SEXP dSNRCutSEXP, SEXP nUsedPCAZSEXP, SEXP nUseRBSEXP, SEXP dPeakFDRCutSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"crl_read_bigwig_impl", (DL_FUNC) &crl_read_bigwig_impl, 4},
    {"crl_dPCA_main_impl", (DL_FUNC) &crl_dPCA_main_impl, 22},
    {NULL, NULL, 0}
};

RcppExport void R_init_crl(DllInfo *dll) {
